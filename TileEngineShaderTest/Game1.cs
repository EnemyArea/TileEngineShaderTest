        ...
        private Texture2D CreateTexture(int layerIndex)
        {
            ...
            for (var mY = 0; mY < this.mapHeight; mY++)
            {
                for (var mX = 0; mX < this.mapWidth; mX++)
                {
                    ...
                    if (worldmapTile.TextureIndex != -1)
                    {
                        switch (worldmapTile.TileTextureType)
                        {
                            ...
                            case TileTextureType.TileA4Wall_3:
                                ...
                                var sourceRectAutotileX1 = textureMap[0, 0] * 16;
                                var sourceRectAutotileY1 = textureMap[0, 1] * 16;

                                var sourceRectAutotileX2 = textureMap[1, 0] * 16;
                                var sourceRectAutotileY2 = textureMap[1, 1] * 16;

                                var sourceRectAutotileX3 = textureMap[2, 0] * 16;
                                var sourceRectAutotileY3 = textureMap[2, 1] * 16;

                                var sourceRectAutotileX4 = textureMap[3, 0] * 16;
                                var sourceRectAutotileY4 = textureMap[3, 1] * 16;
